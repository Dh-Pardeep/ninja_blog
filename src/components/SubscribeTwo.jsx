...
const SubscribeTwo = () => {
    return (
        <div className='container xl:w-[1140px] px-3 sm:px-5 xl:px-0 mx-auto'>
            <div className='flex flex-col lg:flex-row gap-10 lg:gap-20 mb-12 lg:mb-36 mt-[100px]'>
                    ...
                    <div className='mx-4'>
                        <div className='sm:flex justify-center lg:justify-start lg:items-start  lg:flex-col items-center' >
                            <div className='text-center  mb-6 sm:mb-0 lg:mb-6'>
                                <input required type="email" placeholder='Email' className='placeholder:text-light_gray placeholder:font-Roboto placeholder:text-xmd placeholder:font-medium placeholder:leading-normal bg-white rounded w-full sm:w-[288px] lg:m-full max-w-[288px] ps-4 py-3' />
                            </div>
                            <div className='text-center md:text-start sm:ps-5 lg:ps-0 '>
                                <button className='text-white font-Roboto  text-xmd font-medium  leading-[160%] bg-heading rounded py-[9.6px] px-4 '>Sign Up</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div className='flex flex-col sm:flex-row justify-between gap-10 lg:gap-20'>
                    <div>
