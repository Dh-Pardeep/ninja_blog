        ...
        <>
            <header>
                <div className='container xl:w-[1100px]  px-3 sm:px-5 xl:px-0 mx-auto'>
                    <nav className='flex justify-between items-center pt-9'>
                        <div className=' flex items-center  '>
                            <Link to='/' className='font-black leading-normal text-lg font-Merriweather text-heading'>Food Ninja</Link>
                        </div>
                        <ul className={`${showNavbar ? 'flex items-center mb-0 nav_sm p-0 gap-5' : 'gap-5 flex items-center mb-0 nav_sm nav_show p-0'} `}>
                            <li><Link onClick={() => setShowNavbar(true)} className='font-Roboto text-light_gray text-[5vw] sm:text-[3vw] md:text-xmd font-normal leading-normal   relative after:content-[""] after:w-0 after:h-[3px] after:transition-all transition-all  after:ease-in-out ease-in-out after:duration-300 duration-300 after:bg-light_gray after:absolute after:bottom-[-3px] hover:after:w-full hover:after:left-0 after:left-[50%]   ' to="#">Blog</Link></li>
                            <li><Link onClick={() => setShowNavbar(true)} className='font-Roboto text-light_gray text-[5vw] sm:text-[3vw] md:text-xmd font-normal leading-normal   relative after:content-[""] after:w-0 after:h-[3px] after:transition-all transition-all  after:ease-in-out ease-in-out after:duration-300 duration-300 after:bg-light_gray after:absolute after:bottom-[-3px] hover:after:w-full hover:after:left-0 after:left-[50%]   ' to="#">About</Link></li>
                            <li><Link onClick={() => setShowNavbar(true)} className='font-Roboto text-light_gray text-[5vw] sm:text-[3vw] md:text-xmd font-normal leading-normal   relative after:content-[""] after:w-0 after:h-[3px] after:transition-all transition-all  after:ease-in-out ease-in-out after:duration-300 duration-300 after:bg-light_gray after:absolute after:bottom-[-3px] hover:after:w-full hover:after:left-0 after:left-[50%]   ' to="#">Contact</Link></li>
                            <li><Link onClick={() => setShowNavbar(true)} className='font-Roboto text-white bg-light_blue py-2 px-4 rounded-[29px]  text-[5vw] sm:text-[3vw] md:text-xmd font-normal leading-normal transition-all duration-200 ease-in-out hover:bg-white hover:text-light_blue hover:shadow-[0px_2px_6px_0px] hover:shadow-light_blue' to="#">Log in</Link></li>
