                ...
                <div className='container xl:w-[1100px]  px-3 sm:px-5 xl:px-0 mx-auto'>
                    <nav className='flex justify-between items-center '>
                        ...
                        <ul className={`${showNavbar ? 'flex items-center mb-0 nav_sm p-0 gap-5' : 'gap-5 flex items-center mb-0 nav_sm nav_show p-0'} `}>
                            ...
                            <li><button onClick={() => setShowNavbar(true)} className='font-Roboto text-white bg-light_blue py-2 px-4 rounded-[29px]  text-[5vw] sm:text-[3vw] md:text-xmd font-normal leading-normal transition-all duration-200 ease-in-out hover:bg-white hover:text-light_blue hover:shadow-[0px_2px_6px_0px] hover:shadow-light_blue' >Log in</button></li>
