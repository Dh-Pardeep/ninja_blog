...
const HeroSection = () => {
    return (
        <div className='container xl:w-[1100px] px-3 sm:px-5 xl:px-0 mx-auto'>
            ...
            <div className='border border-border_color bg-white max-w-[430px] pt-[17px] pb-[16px] px-7 rounded-md mx-auto mt-8 sm:mt-10 md:mt-12 lg:mt-14 flex justify-between items-center'>
