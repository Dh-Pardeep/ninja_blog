                        ...
                        <form>
                            <div className='sm:flex justify-center lg:justify-start lg:items-start lg:flex-col items-center'>
                                <div className='text-center mb-6 sm:mb-0 lg:mb-6  lg:w-full'>
                                    <input required type="email" placeholder='Email' className='placeholder:text-light_gray placeholder:font-Roboto placeholder:md:text-xmd placeholder:text-sm placeholder:font-medium placeholder:leading-normal bg-white rounded w-full  sm:w-[288px] lg:w-full max-w-[350px] lg:max-w-[305px] ps-4 py-3 outline-none' />
                                </div>
                                <div className='text-center md:text-start sm:ps-5 lg:ps-0'>
                                    <button className='text-white font-Roboto  text-sm md:text-xmd font-medium leading-[160%] bg-heading rounded py-[9.6px] px-4 transition-all duration-200 ease-in-out hover:bg-white hover:text-light_blue hover:shadow-[0px_2px_6px_0px] hover:shadow-black'>Sign Up</button>
                                </div>
                            </div>
                        </form>
                    </div>
